...
const Login = () => {
    ...
    return(
        <div className="h-screen flex items-center justify-center">
            <div className="bg-white  p-6 w-[40%] rounded-lg">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-6">
                        ...
                        <input onChange={handleChange} onFocus={() => setLoginError(null)} name="username" type="text" placeholder="usename" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg   block w-full p-2.5"  required></input>
                    </div>
                    <div className="mb-6">
