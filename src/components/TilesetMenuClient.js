...
const TilesetMenuClient = ({tilesetVisibility }) => {
    ...
    return(
        <>
            ...
            {/*Div tileset menu*/}
            <div ref={containerMenu} className="absolute top-14 ml-2 p-1 pl-3 pr-3 bg-white text-black rounded-lg border-[1px] drop-shadow-lg h-[20%]  overflow-y-scroll text-[80%]  hidden">
...
export default TilesetMenuClient;